...
class PromoterActivityDriveAPI extends RESTDataSource
{
    ...
    // POST
    async postCreatePromoterActivityDrive ( entities )
    {
        console.log("POST CREATE PROMOTER ACTIVITY DRIVE");
        console.log(entities);
        const data = this.post( `webresources/promoterActivityDrive`, entities);
        return data;
    }

}
module.exports = PromoterActivityDriveAPI;