...
class PromoterActivityCTACollect extends RESTDataSource
{
    ...
    // POST
    async postCreatePromoterActivityCTACollect ( entities )
    {
        console.log("POST CREATE PROMOTER ACTIVITY DRIVE");
        console.log(entities);
        const data = this.post( `webresources/promoterActivityCTACollect`, entities);
        return data;
    }

}
module.exports = PromoterActivityCTACollect;